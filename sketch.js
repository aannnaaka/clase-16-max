...
function setup() {
  ...
  //crear sprite y agregar imagen de gameOver
  /*gameOver 
  gameOver*/
  
  //crear sprite y agregar imagen de restart
  /*restart
  restart*/
  ...
  //Ver el radio de colisión y hacerlo más pequeño
  trex.setCollider("rectangle",0,0,700,50);  
